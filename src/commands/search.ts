...
Repository targets use github:org/repo[@ref], codeberg:owner/repo[@ref], gitlab:group[/subgroup...]/project[@ref],
...
export function registerSearchCommand(program: Command) {
  program
    ...
    .requiredOption(
      "--in <target>",
      "Search target: registry:name[@version] (artifact/manifest-root scope; Swift: swift:github.com/<owner>/<repo>, Zig: zig:gh/<owner>/<repo>), repository github:owner/repo, codeberg:owner/repo, gitlab:group/subgroup/project (optional @ref), or an approved full HTTPS URL for full/sibling-package scope, or site:<host[/path]>",
      collectRepeatable,
      [] as string[],
    )
    .addOption(
