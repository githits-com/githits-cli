 ...
 * `solution_id` is the UUID at the end of that URL. Until the backend
 * exposes it as a structured field, surfaces extract it client-side so
 * agents and JSON consumers can identify a result without parsing markdown.
 *
