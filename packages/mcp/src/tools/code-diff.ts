...
const schema: ZodRawShape = {
  target: z
    .string()
    .describe(
      "One unversioned compact target string such as `npm:express` or `github:expressjs/express`. Do not embed a version or ref.",
    ),
  from: z
    .string()
