...
const schema: ZodRawShape = {
  ...
  wait_timeout_ms: z.coerce
    ...
    .optional()
    .describe(
      "Milliseconds to wait for progress or completion before returning the latest status (0-60000; default 30000).",
    ),
  format: z
    .enum(["text", "json"])
    .default("text")
...
const DESCRIPTION =
  ...
  "The tool waits up to 30 seconds by default; set `wait_timeout_ms` from 0 to 60000 to change that bounded wait.";
