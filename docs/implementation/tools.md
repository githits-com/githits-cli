...
supplies the host-neutral authentication action `Authenticate with GitHits, then retry.`; terms errors use their canonical `acceptanceUrl` action, and
