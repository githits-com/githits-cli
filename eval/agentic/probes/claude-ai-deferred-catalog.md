...
- GitHits:pkg_changelog — Find release notes and changelog history for a package.
...
- GitHits:quick_start — Call quick_start first to choose tools and load untrusted-content rules.
