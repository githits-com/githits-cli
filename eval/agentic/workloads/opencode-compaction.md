...
Ground each claim in specific repository evidence such as file paths, symbols,
configuration fields, or documentation. State the exact served ref and commit
when available; if the requested target is unavailable, disclose the fallback
ref or commit used and why.
